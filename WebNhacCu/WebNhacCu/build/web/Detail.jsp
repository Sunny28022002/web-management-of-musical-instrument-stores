...
<html lang="en">
    ...
    <body class="main-layout">
        ...
        <div class="header_section header_main">
            ...
            <div style="height: 850px; padding-top: 180px; margin-left: 120px;">
                <a href="#" class="overlay-close"></a>
                <div class="dialog-body_3">
                    <div action="AddProductToCart" method="post">
                        <div class="">
                            <div class="row">
                                <div class="col-md-6"><img class="list_product " src="${detail.image}"></div>
                            <div class="col-md-6">
                                <p class="size_detail">
                                <h4 class="modal-title">${detail.name}</h4>
                                <font face="vernada">${detail.description}</font>
                                </p>
                                <div style="margin-top: -25px" class="row center">
                                    <div class="col">
                                        <form action="AddProductToCart" method="post" >
                                            ...
                                            <c:if test="${sessionScope.acc == null}">
                                                <a href="LoginControl"><input type="button" class="btn btn-success btn-block" value="Add to cart"></a>
                                                </c:if>
                                        </form>
                                    </div>
                                    <div style="margin-top: 50px" class="col">
                                        <p class="btn btn-danger btn-block">${detail.price}$</p>
                                    </div>
                                </div>
                            </div>
                        </div>
