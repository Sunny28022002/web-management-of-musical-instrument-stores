        ...
        <div class="header_section header_main">
            ...
            <div class="search">
                <form style="background-color: black;" action="search" method="post">
                    ...
                    <button style="margin-left: -53px; background-color: white;" type="submit"><i class="fa fa-search"></i></button>
                </form>
            </div>             
            <div class="layout_padding gallery_guitar_section">
                <h1 style="margin-left: 120px;" class="new_text"><strong>Search Results ${search}</strong></h1>
            <div class="container">
                <div class="row">
